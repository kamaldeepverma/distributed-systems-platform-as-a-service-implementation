...
schedule.every(1).seconds.do(InitialiseService,'172.17.0.2','ain2','aout2')
schedule.every(1).seconds.do(InitialiseService,'172.17.0.2','ain12','ain2')
